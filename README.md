...
Project made with the HTML5 markup language to define the elements, along with CSS3 and JavaScript. And the challenge is to make a clean code site, with declarative code and imperative code, and in the end refactor the code to make it more performant, without changing its functionalities.
